...
class DetailAktaKelahiran extends StatelessWidget {
  @override
                  ...
                  Container(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        Text(
                          '3. FotoCopy Surat Bidan (2 Lembar + Asli)',
                          style: primaryTextStyle.copyWith(
                            fontSize: 16,
                          ),
                          textAlign: TextAlign.center,
                        ...
                        Text(
                          '4. FotoCopy 2 Orang Saksi masing - masing (3 Lembar)',
                          style: primaryTextStyle.copyWith(
                            fontSize: 16,
                          ),
                        ),
                        ...
                        Text(
                          '7. FotoCopy Ijazah  (jika ada 1 Lembar)',
                          style: primaryTextStyle.copyWith(
                            fontSize: 16,
                          ),
                          textAlign: TextAlign.center,
